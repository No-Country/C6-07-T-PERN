...
import { PlatformIcon, ArrowDownIcon, DisneyIcon, HboIcon, ImdbIcon, NetflixIcon, AmazonIcon } from "../../ui/icons";
...
const dictionary = {
  "Netflix": <PlatformIcon key={platform.id}><NetflixIcon></NetflixIcon></PlatformIcon>,
  "Disney Plus": <PlatformIcon key={platform.id}><DisneyIcon></DisneyIcon></PlatformIcon>,
"HBO Max": <PlatformIcon key={platform.id}><HboIcon></HboIcon></PlatformIcon>,
"Amazon Prime":<PlatformIcon key={platform.id}><AmazonIcon></AmazonIcon></PlatformIcon>
}
