  ...
  return (
    <div>
      <form>
        ...
        <input className={css.mailForm} name="password" type="text" />
        ...
        <div className={css.regButton}>
          ...
          <button className={css.registerForm}>Ingresa</button>
        </div>
      </form>
    </div>
  );
    ...
    <div>
      <form>
        ...
        <div className={css.regButton}>
          ...
          <button className={css.registerForm}>Registrarse</button>
        </div>
      </form>
    </div>
  );
